  ...
  return (
    <main className={shared.subPage}>
      <div className={shared.subInner}>
        <img
          src="/radiant/radiant-logo-dark.png"
          alt="Radiant"
        ...
        <p className={shared.subKicker}>proposal</p>
        <h1 className={shared.subTitle}>Radiant</h1>
        <p className={shared.subCopy}>
          A one-pager with samples of my writing and work for Radiant&apos;s LinkedIn and X channels.
        </p>
