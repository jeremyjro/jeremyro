...
const SOCIALS = [
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/jeremyrooo/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@jeremyjro",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function SocialLinks() {
  return (
    <nav className={styles.stack} aria-label="Social links">
      {SOCIALS.map((s) => (
        <a
          key={s.label}
          href={s.href}
